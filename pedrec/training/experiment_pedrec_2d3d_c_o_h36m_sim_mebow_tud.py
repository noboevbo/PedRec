...
def main():
    ...
    experiment_description = ExperimentDescription(
        ...
        experiment_name="experiment_pedrec_p2d3d_c_o_h36m_sim_mebow_tud",
        initialization_notes="Initialized from p2d3d_c_o_h36m_sim_mebow",
    ...
    experiment_description.coco_train_dataset_cfg.use_mebow_orientation = True
    experiment_description.coco_train_dataset_cfg.rotation_factor = 0
    ...
    initialize_weights_with_same_name_and_shape(net, experiment_paths.pedrec_2d3d_c_o_h36m_sim_mebow_path)
    # net.loss_head.reset_sigmas()
...
def cycle(cycle_num: int, experiment_description: ExperimentDescription, net, device, frozen_1=None, frozen_2=None,
    ...
    net.load_state_dict(torch.load(os.path.join(experiment_description.experiment_paths.output_dir,
                            f"{experiment_description.experiment_name}_{cycle_num}_01.pth")))
