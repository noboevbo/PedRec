...
def main():
    ...
    experiment_description = ExperimentDescription(
        ...
        experiment_name="experiment_pedrec_p2d_h36m_sim",
        initialization_notes="Initialized from p2d_h36m",
    ...
    initialize_weights_with_same_name_and_shape(net, experiment_description.experiment_paths.pedrec_2d_h36m_path)
    net.to(device)
