...
from pedrec.training.experiments.experiment_path_helper import get_experiment_paths_gpu01
...
def main():
    ...
    experiment_paths = get_experiment_paths_gpu01()
    experiment_description = ExperimentDescription(
        net_name="PedRecNet2D",
        experiment_name="experiment_pedrec_p2d3d_h36m_sim",
        initialization_notes="Initialized from p2d3d_h36m",
    ...
    initialize_weights_with_same_name_and_shape(net, experiment_description.experiment_paths.pedrec_2d3d_h36m_path)
    net.to(device)
