...
def main():
    ...
    experiment_description = ExperimentDescription(
        ...
        experiment_name="experiment_pedrec_p2d3d_c_o_sim",
        initialization_notes="Initialized from p2d3d_c_sim",
    ...
    initialize_weights_with_same_name_and_shape(net, experiment_description.experiment_paths.pedrec_2d3d_c_sim_path)
