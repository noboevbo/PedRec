...
class MTLLRFinder(object):
    ...
    def __init__(
        ...
        # needed
        self.model_device = next(self.criterion.parameters()).device
        self.state_cacher = StateCacher(memory_cache, cache_dir=cache_dir)
        self.state_cacher.store("model", self.criterion.state_dict())
    ...
    def reset(self):
        ...
        self.criterion.load_state_dict(self.state_cacher.retrieve("model"))
        self.optimizer.load_state_dict(self.state_cacher.retrieve("optimizer"))
        self.criterion.to(self.model_device)
    ...
    def _train_batch(self, train_iter, accumulation_steps, non_blocking_transfer=True):
        ...
        for i in range(accumulation_steps):
            ...
            # Forward pass
            _, loss = self.criterion(inputs, labels)
